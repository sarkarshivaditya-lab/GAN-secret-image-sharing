...
def save_visual_results(
    ...
    output_dir = "outputs/privacy_adversarial"
...
def main():
    ...
    print()
    print(
        "Independent privacy evaluation complete."
    )
