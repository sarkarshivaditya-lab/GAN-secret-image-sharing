...
CHECKPOINT_DIR = (
    "checkpoints/privacy_sweep/lambda_0.10"
)
...
def main():
    print("Device:", DEVICE)
    print()
    print("λ = 0.10 independent attacker evaluation")
    print(
    ...
    print()
    print("=" * 60)
    print("λ = 0.10 INDEPENDENT ATTACKER RESULTS")
    print("=" * 60)
    ...
    print()
    print(
        "Independent λ = 0.10 evaluation complete."
    )
